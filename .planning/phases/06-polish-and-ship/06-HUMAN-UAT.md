...
[awaiting human testing — Matt to verify in morning]
...
expected: Running dist/Notal-0.1.0-setup.exe installs the app. Windows Start Menu shortcut reads "Notal". Desktop shortcut (if created) reads "Notal".
result: [pending]

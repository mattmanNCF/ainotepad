...
| 10. Dynamic Wiki Graph Parameters | 0/4 | Not started | - |
...
**Plans**: 4 plans
Plans:
- [ ] 10-01-PLAN.md — Install @radix-ui/react-slider + IPC scaffold (graph-params:get/save + electron-conf persistence + GraphParams contract)
